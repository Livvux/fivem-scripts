...
Citizen.CreateThread(function()
	...
	while true do
		...
		-- OLD STUFF THAT WAS LAGGING
		-- TriggerServerEvent('trew_hud_ui:getServerInfo')
		TriggerEvent('trew_hud_ui:setInfo')
...
-- ESX NATIVE FOR MONEY, BLACK MONEY, SOCIETY AND JOB
...
AddEventHandler('esx:setJob', function(job)
	local jobstuff = job.label..': '..job.grade_label
	SendNUIMessage({ action = 'setText', id = 'job', value = jobstuff })
end)
...
AddEventHandler('trew_hud_ui:setInfo', function()
